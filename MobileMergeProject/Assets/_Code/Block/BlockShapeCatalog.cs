...
namespace _Code.Block
{
    public static class BlockShapeCatalog
    {
        private static readonly BlockShape[] _shapes =
        {
            ...
            new BlockShape("Three Horizontal", new Vector2Int(0, 0), new Vector2Int(1, 0), new Vector2Int(2, 0)),
            new BlockShape("Three Vertical", new Vector2Int(0, 0), new Vector2Int(0, 1), new Vector2Int(0, 2)),
            new BlockShape("Four Horizontal", new Vector2Int(0, 0), new Vector2Int(1, 0), new Vector2Int(2, 0), new Vector2Int(3, 0)),
            new BlockShape("Four Vertical", new Vector2Int(0, 0), new Vector2Int(0, 1), new Vector2Int(0, 2), new Vector2Int(0, 3)),
            new BlockShape("Five Horizontal", new Vector2Int(0, 0), new Vector2Int(1, 0), new Vector2Int(2, 0), new Vector2Int(3, 0), new Vector2Int(4, 0)),
